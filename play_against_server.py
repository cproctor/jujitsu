...
# Connects to a jujitsu server running on this computer. (Make sure you 
# run start_server.py in another Terminal window before running this
# script.) If you know the IP address and port for a different computer 
# running a jujitsu server, you can connect to that server by entering its 
# address instead of 'localhost' below.
